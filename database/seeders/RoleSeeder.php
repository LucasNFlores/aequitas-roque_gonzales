...
class RoleSeeder extends Seeder
{
    ...
    private const PERMISSIONS_BY_ROLE = [
        'Secretario' => [
            ...
            'modificar_turnos',
            'modificar_turnos_externos',
            'eliminar_turnos',
            'ver_agenda_profesional',
            'cargar_documentacion',
            'reemplazar_documentacion',
            'eliminar_documentacion',
            'visualizar_documentacion',
            'registrar_comprobantes_pago',
            'ver_comprobantes_pago',
            'asignar_profesionales',
            'reasignar_profesionales',
            'listar_filtrar_clientes',
            'listar_filtrar_procesos',
            'consultar_historial_estados',
            'cambiar_perfil',
        ...
        'Profesional' => [
            ...
            'consultar_legajos',
            'actualizar_estados_proceso',
            'registrar_reportes',
            'editar_reportes_propios',
            'eliminar_reportes_propios',
            'consultar_reportes',
            'listar_filtrar_procesos',
            'consultar_historial_estados',
            'cambiar_perfil',
        ...
        'Coordinador' => [
            ...
            'consultar_historial_estados',
            'cambiar_perfil',
            'asignar_especialidad_servicio',
            'consultar_notificaciones',
            'gestionar_estados_proceso',
            'gestionar_categorias_documentos',
        ],
        'Directivo' => [
            'listar_usuarios',
            'agregar_usuarios',
